...
<section class="panel panel-default content">
    ...
    <div class="panel-body">
        <form action="<?php echo $this->bu('eleve', 'resultatLancerQuestionnaire', array('cours_name' => $cours_name, 'questionnaire_name' => $questionnaire_name, 'compteur' => $compteur, 'question_id' => $question->question_id)); ?>" method="post">
            <table>
                <?php if($question->temps_imparti > 0): ?>
                    <tr>
