                                            ...
                                            <?php foreach ($retards as $element): ?>
                                                <tr> 
                                                    ...
                                                    <td>
                                                        ...
                                                        <form action="<?php echo $this->bu('adminPresence', 'justificationRetardFromCoursDetail', array('retard_id' => $element->retard_id, 'cours_id' => $cours->cours_id)); ?>" method="post">
                                        ...
                                        <tbody>
                                            <?php foreach ($absences as $element): ?>
                                                <tr> 
                                                    ...
                                                    <td>
                                                        <?php if($element->justifiee == 0): ?>
                                                        <form action="<?php echo $this->bu('adminPresence', 'justificationAbsenceFromEleveDetail', array('absence_id' => $element->absence_id, 'cours_id' => $cours->cours_id)); ?>" method="post">
                                                            <button id="btn-valider" type="submit" class="btn btn-primary btn-lg">Archiver</button>
                                                        </form>
                                                        <?php else: echo "OK"; endif; ?>
                                                    </td>
